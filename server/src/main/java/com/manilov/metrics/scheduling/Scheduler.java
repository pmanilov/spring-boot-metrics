...
public class Scheduler {
    ...
    public Scheduler(MeterRegistry meterRegistry, MetricService metricService) {
        ...
        lastThroughput = meterRegistry.gauge("last_throughput", new MutableDouble(0));
        lastDelay = meterRegistry.gauge("last_delay", new MutableDouble(0));
        lastSize = meterRegistry.gauge("last_packet_size", new MutableDouble(0));
