...
csv = "experiment_results_packet_loss.csv"

clients_values  = "1 10 50 100"
overhead_values = "0 1024 4096 16384 32768"
...
do for [clients in clients_values] {
    do for [overhead in overhead_values] {
        ...
        set output sprintf('result_packet_loss_c%s_o%s.png', clients, overhead)
        set multiplot layout 2,1 \
            title sprintf("Клиенты: %s, Размер полезной нагрузки: %s байт", clients, overhead) font ",16"
