...
public class Scheduler {
    ...
    public Scheduler(MeterRegistry meterRegistry) {
        ...
        lastThroughput = meterRegistry.gauge("last_throughput_mqtt", new MutableDouble(0));
        lastDelay = meterRegistry.gauge("last_delay_mqtt", new MutableDouble(0));
        lastSize = meterRegistry.gauge("last_packet_size_mqtt", new MutableDouble(0));
    }
