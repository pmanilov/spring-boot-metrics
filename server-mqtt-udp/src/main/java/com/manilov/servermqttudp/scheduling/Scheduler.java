package com.manilov.servermqttudp.scheduling;
...
public class Scheduler {
    ...
    public Scheduler(MeterRegistry meterRegistry) {
        avgThroughput = meterRegistry.gauge("avg_throughput_mqtt_udp", new MutableDouble(0));
        avgDelay = meterRegistry.gauge("avg_delay_mqtt_udp", new MutableDouble(0));
        avgSize = meterRegistry.gauge("avg_packet_size_mqtt_udp", new MutableDouble(0));
        lastThroughput = meterRegistry.gauge("last_throughput_mqtt_udp", new MutableDouble(0));
        lastDelay = meterRegistry.gauge("last_delay_mqtt_udp", new MutableDouble(0));
        lastSize = meterRegistry.gauge("last_packet_size_mqtt_udp", new MutableDouble(0));
    }
